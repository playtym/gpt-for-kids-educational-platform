        ...
        <CardContent className="p-4 space-y-3">
          ...
          {thinkingPrompts.length > 0 && (
            <div className="space-y-2">
              <h4 className="text-sm font-semibold text-blue-700">Think about:</h4>
              <div className="space-y-1">
                {thinkingPrompts.map((prompt, index) => (
                  <Button
                    ...
                    className="w-full justify-start text-left text-blue-600 hover:bg-blue-50 h-auto p-2"
                  >
                    {prompt}
                  </Button>
                ))}
          ...
          {nextSteps.length > 0 && (
            <div className="space-y-2">
              <h4 className="text-sm font-semibold text-blue-700">Next steps:</h4>
              <div className="space-y-1">
        ...
        <CardContent className="p-4 space-y-4">
          ...
          {metadata?.progress && (
            <div className="space-y-2">
              ...
              <Progress value={metadata.progress} className="h-2 bg-blue-100" />
            </div>
          )}
      ...
      <Card className="bg-white border border-purple-200 shadow-sm">
        <CardContent className="p-4 space-y-4">
          <div className="text-center space-y-4">
            ...
            <div className="space-y-2">
              <h3 className="text-xl font-bold text-purple-800">🎉 Journey Complete!</h3>
            ...
            <div className="space-y-3">
              <h4 className="font-semibold text-gray-700">What's next?</h4>
              
              {/* Follow-up topic suggestions */}
              {metadata?.nextTopics && metadata.nextTopics.length > 0 && onFollowUpTopic && (
                <div className="space-y-3">
                  <h5 className="text-sm font-medium text-purple-700">🚀 Go Deeper:</h5>
                  <div className="space-y-2">
                    {metadata.nextTopics.map((nextTopic, index) => (
                      <Button
                        ...
                        disabled={isLoading}
                        className="w-full text-left h-auto p-3 border-purple-200 hover:border-purple-300 hover:bg-purple-50"
                      >
                        <div className="space-y-1">
                  ...
                  <div className="border-t border-purple-200 pt-3">
                    <p className="text-xs text-purple-600 mb-2">Or test your knowledge:</p>
                  </div>
                </div>
              )}
    ...
    <Card className="bg-white border border-purple-200 shadow-sm">
      <CardContent className="p-4 space-y-4">
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="font-semibold text-purple-800">Learning Together</span>
        </div>
