  ...
  return (
    <Dialog open={isOpen} onOpenChange={canClose ? onClose : undefined}>
      <DialogContent className="sm:max-w-2xl" hideCloseButton={required}>
        ...
        {ageGroup && (
          <div className="mt-6 p-4 bg-apple-green/10 rounded-lg border border-apple-green/20">
            <div className="flex items-center space-x-2">
              <div className="w-3 h-3 bg-apple-green rounded-full animate-pulse"></div>
              <p className="text-apple-green font-medium">
