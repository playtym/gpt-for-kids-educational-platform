    ...
    return (
      <Card className="w-full max-w-2xl mx-auto">
        <CardContent className="p-6">
          <div className="flex items-center space-x-2 text-apple-yellow">
            <AlertCircle size={20} />
      ...
      <CardContent className="space-y-6">
        ...
        {question && (
          <div className="space-y-4">
            ...
            <div className="p-6 bg-gradient-to-br from-apple-orange/10 to-apple-yellow/10 rounded-lg border-l-4 border-apple-orange">
